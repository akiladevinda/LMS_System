...
<ul>
  ...
  <a href="logOutLect.php"><input type="button" class="Lgbutton" value="Log Out" align="right" ></a>
...
<div class="accLog">
<form method="post" action="loginConnectLect.php">

	<h3 style="color:white; font-family:verdana">Lecturer ID : </h3><br>
