...
<h1 style="color:#0771F0 ; font-size: 20pt; font-family:gotham; text-align:center" >Course : Business Management </h1>


<nav>
  <ul>
    <li><a href="management.php"><input type="button" class="buttonCom" value="Add Notes" align="right"></a></li><br><br><br><br>
    <a href="viewMgNotes.php" class="linkToview">View Notes</a>
  </ul>
</nav>
...
$link=mysqli_connect('localhost','root','','mngNotes');
