...
<ul>
  ...
  <li class="dropdown">
    ...
    <div id="regButton">
  <a href="mgtLogOut.php"><input type="button" class="Lgbutton" value="Logout" align="right" ></a>
  </div>
...
<nav>
  <ul>
    ...
    <a href="viewMgtNotes.php" class="linkToview">View Notes</a>
  </ul>
</nav>

<div id="article" >

  <form action="addNotesMgt.php" method="POST">
