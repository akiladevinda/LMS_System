...
<ul>
  ...
  <a href="mgtLogOut.php"><input type="button" class="Lgbutton" value="Log Out" align="right" ></a>
...
<div class="accLog">
<form method="post" action="loginConnectToMgt.php">
